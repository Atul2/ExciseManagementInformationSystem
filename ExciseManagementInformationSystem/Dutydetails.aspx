<%@ Page Title="" Language="C#" MasterPageFile="~/ExciseMIS.Master" AutoEventWireup="true" CodeBehind="Dutydetails.aspx.cs" Inherits="ExciseManagementInformationSystem.Dutydetails" %>
    ...
    <form runat="server">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="form-group">
                    ...
                    <asp:DropDownList class="form-control" ID="dropdownFYear1" runat="server" OnLoad="dropdownFYear1_SelectedIndexChanged" OnSelectedIndexChanged="dropdownFYear1_SelectedIndexChanged" AppendDataBoundItems="True" AutoPostBack="True">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="form-group">
                    ...
                    <asp:DropDownList class="form-control" ID="dropdownWareHouse1" runat="server" OnSelectedIndexChanged="dropdownWareHouse1_SelectedIndexChanged" AppendDataBoundItems="True" AutoPostBack="True">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
        ...
        <div id="row">
            ...
            <div class="col-lg-2 col-md-4">
                <div class="form-group">
                    <b>
                        <asp:Label for="from1" runat="server" Text="From Date"></asp:Label></b>
                    <div class="input-group date">
                        <asp:TextBox class="form-control" type="text" ID="from1" runat="server" OnTextChanged="from1_TextChanged" />
                        <div class="input-group-addon">
                            <i id="cal" class="fa fa-calendar"></i>
                        </div>
                    </div>

                    <ajaxToolkit:CalendarExtender TargetControlID="from1" runat="server" Format="dd/MM/yyyy" PopupButtonID="cal" PopupPosition="BottomRight" />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/]\d{4}" ControlToValidate="from1" runat="server" ForeColor="Red" ErrorMessage="invalid date"></asp:RegularExpressionValidator>
            ...
            <div class="col-lg-2 col-md-4">
                <div class="form-group">
                    <b>
                        <asp:Label for="to1" runat="server" Text="To Date"></asp:Label></b>
                    <div class="input-group date">
                        <asp:TextBox class="form-control" type="text" ID="to1" runat="server" OnTextChanged="to1_TextChanged" />
                        <div class="input-group-addon">
                            <i id="cal2" class="fa fa-calendar"></i>
                        </div>
                    </div>
                    <ajaxToolkit:CalendarExtender TargetControlID="to1" runat="server" Format="dd/MM/yyyy" PopupButtonID="cal2" PopupPosition="BottomRight" />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/]\d{4}" ControlToValidate="to1" runat="server" ForeColor="Red" ErrorMessage="invalid date"></asp:RegularExpressionValidator>
