<%@ Page Title="" Language="C#" MasterPageFile="~/ExciseMIS.Master" AutoEventWireup="true" CodeBehind="Graph.aspx.cs" Inherits="ExciseManagementInformationSystem.Graph" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <section class="content">
        <form runat="server">
                    ...
                    <div class="col-xs-12">
                        <div class="panel panel-warning">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>WareHouse Wise DutyAmount Chart</strong> &nbsp; &nbsp;&nbsp;<button onclick="printDiv('bar-chart')" class="btn btn-warning btn-sm">print</button></h3>
                            </div>
            ...
            <section id="WareHouse Wise Dispatch Chart">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>WareHouse Wise Dispatch Chart</strong>&nbsp; &nbsp;&nbsp;<button onclick="printDiv('bar-chart2')" class="btn btn-primary btn-sm">print</button></h3>
                            </div>
                            <div class="panel-body">
            ...
            <section id="WareHouse Wise Invoice Chart">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>WareHouse Wise Invoice Chart</strong>&nbsp; &nbsp;&nbsp;<button onclick="printDiv('bar-chart3')" class="btn btn-success btn-sm">print</button></h3>
                            </div>
                            <div class="panel-body">
            ...
            <section id="Supplier Wise Dispatch Chart">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-warning">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Supplier Wise Dispatch Chart</strong>&nbsp; &nbsp;&nbsp;<button onclick="printDiv('bar-chart4')" class="btn btn-warning btn-sm">print</button></h3>
                            </div>
                            <div class="panel-body">
